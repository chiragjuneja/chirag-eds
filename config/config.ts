...
export const BASE = "";
export const PRIME_HOME = "/home";
export const PRIME_CATALOG = "/catalog";
export const NOT_FOUND = "/notfound";
export const PRIME_TRAINING_WITHOUT_INSTANCE =
  "/trainingOverview.html/trainingId/:trainingId";
export const PRIME_TRAINING = `${PRIME_TRAINING_WITHOUT_INSTANCE}/trainingInstanceId/:trainingInstanceId`;
export const PRIME_INSTANCE = "/instance.html/trainingId/:trainingId";

export const getPathWithQp = (PATH: string) => {
